    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlagStates", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DTG = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    FlagStateID = table.Column<int>(type: "int", nullable: false),
                    ActivityNameID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipActivity", x => x.ID);
                    table.ForeignKey(
                        name: "FK_ShipActivity_ActivityName_ActivityNameID",
                        column: x => x.ActivityNameID,
                        principalTable: "ActivityName",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShipActivity_FlagStates_FlagStateID",
                        column: x => x.FlagStateID,
                        principalTable: "FlagStates",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShipActivity_VesselType_VesselTypeID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipActivity_ActivityNameID",
                table: "ShipActivity",
                column: "ActivityNameID");

            migrationBuilder.CreateIndex(
                name: "IX_ShipActivity_FlagStateID",
                table: "ShipActivity",
                column: "FlagStateID");

            migrationBuilder.CreateIndex(
                name: "IX_ShipActivity_VesselTypeID",
                table: "ShipActivity",
                column: "VesselTypeID");
        }
